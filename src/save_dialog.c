...
// Not present as a config option in this fork's version of pokeemerald-expansion
// (miriamlefae's branch has a newer config knob we don't have). Default to FALSE
// to preserve the normal save confirmation prompt.
#define SKIP_SAVE_CONFIRMATION FALSE
