...
const u8 *const gPocketNamesStringsTable[] =
{
    ...
    [POCKET_MEDICINE] =      COMPOUND_STRING("Rimedi"),
    [POCKET_POKE_BALLS] =    COMPOUND_STRING("Poké Ball"),
    [POCKET_BATTLE_ITEMS] =  COMPOUND_STRING("St. Lotta"),
    [POCKET_BERRIES] =       COMPOUND_STRING("Bacche"),
    [POCKET_TREASURES] =     COMPOUND_STRING("Tesori"),
    [POCKET_TM_HM]  =        COMPOUND_STRING("TM e HM"),
    [POCKET_KEY_ITEMS] =     COMPOUND_STRING("Strum. Base")
};
...
const u8 gText_YourPkmnWereRestored[] = _("I tuoi Pokémon sono stati curati!{PAUSE_UNTIL_PRESS}");
const u8 gText_PokevialHasDoses[] = _("Il {STR_VAR_1} ha {STR_VAR_2} cariche!\nUsarlo?");
const u8 gText_PokevialIsEmpty[] = _("Il {STR_VAR_1} è vuoto...\nRicaricalo al {STR_VAR_2}.");
...
//descriptions
const u8 gText_SideQuestDesc_1[] = _("Parla con Fiammetta.");
const u8 gText_SideQuestDoneDesc_1[] = _("Hai parlato con Fiammetta.");
