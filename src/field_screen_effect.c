...
void WarpFadeOutScreen(void)
{
    ...
    if (header->regionMapSectionId != gMapHeader.regionMapSectionId
     && MapHasPreviewScreen(header->regionMapSectionId, MPS_TYPE_CAVE))
    {
...
void FieldCB_ForestMapPreview(void)
{
    ...
    FillPalBufferBlack();  // prevent 1-frame flash: LoadPalette fills gPlttBufferFaded with real colors
