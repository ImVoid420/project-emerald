...
{
    [SLIDING_PUZZLE_KABUTO]     = {sKabutoPuzzle_Gfx,     0x200 * 16, GFXTAG_TILES},
    [SLIDING_PUZZLE_OMANYTE]    = {sOmanytePuzzle_Gfx,    0x200 * 16, GFXTAG_TILES},
    [SLIDING_PUZZLE_AERODACTYL] = {sAerodactylPuzzle_Gfx, 0x200 * 16, GFXTAG_TILES},
    [SLIDING_PUZZLE_HO_OH]      = {sHoOhPuzzle_Gfx,       0x200 * 16, GFXTAG_TILES},
