...
static const union AnimCmd sAnim_Tile0[]  = { ANIMCMD_FRAME(0  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile1[]  = { ANIMCMD_FRAME(1  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile2[]  = { ANIMCMD_FRAME(2  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile3[]  = { ANIMCMD_FRAME(3  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile4[]  = { ANIMCMD_FRAME(4  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile5[]  = { ANIMCMD_FRAME(5  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile6[]  = { ANIMCMD_FRAME(6  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile7[]  = { ANIMCMD_FRAME(7  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile8[]  = { ANIMCMD_FRAME(8  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile9[]  = { ANIMCMD_FRAME(9  * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile10[] = { ANIMCMD_FRAME(10 * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile11[] = { ANIMCMD_FRAME(11 * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile12[] = { ANIMCMD_FRAME(12 * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile13[] = { ANIMCMD_FRAME(13 * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile14[] = { ANIMCMD_FRAME(14 * 16, 30), ANIMCMD_END };
static const union AnimCmd sAnim_Tile15[] = { ANIMCMD_FRAME(15 * 16, 30), ANIMCMD_END };

static const union AnimCmd *const sAnims_Tiles[] =
{
    sAnim_Tile0,  sAnim_Tile1,  sAnim_Tile2,  sAnim_Tile3,
    sAnim_Tile4,  sAnim_Tile5,  sAnim_Tile6,  sAnim_Tile7,
    sAnim_Tile8,  sAnim_Tile9,  sAnim_Tile10, sAnim_Tile11,
    sAnim_Tile12, sAnim_Tile13, sAnim_Tile14, sAnim_Tile15,
};

static const union AffineAnimCmd sSpriteAffineAnim_Rotated0[]   = { AFFINEANIMCMD_FRAME(0x100, 0x100,   0, 0), AFFINEANIMCMD_JUMP(0) };
static const union AffineAnimCmd sSpriteAffineAnim_Rotated90[]  = { AFFINEANIMCMD_FRAME(0x100, 0x100, -64, 0), AFFINEANIMCMD_JUMP(0) };
static const union AffineAnimCmd sSpriteAffineAnim_Rotated180[] = { AFFINEANIMCMD_FRAME(0x100, 0x100,-128, 0), AFFINEANIMCMD_JUMP(0) };
static const union AffineAnimCmd sSpriteAffineAnim_Rotated270[] = { AFFINEANIMCMD_FRAME(0x100, 0x100,  64, 0), AFFINEANIMCMD_JUMP(0) };

static const union AffineAnimCmd sSpriteAffineAnim_RotatingClockwise0to90[]      = { AFFINEANIMCMD_FRAME(0x100,0x100,   0,0), AFFINEANIMCMD_FRAME(0x0,0x0,-8,8), AFFINEANIMCMD_END };
static const union AffineAnimCmd sSpriteAffineAnim_RotatingClockwise90to180[]    = { AFFINEANIMCMD_FRAME(0x100,0x100, -64,0), AFFINEANIMCMD_FRAME(0x0,0x0,-8,8), AFFINEANIMCMD_END };
static const union AffineAnimCmd sSpriteAffineAnim_RotatingClockwise180to270[]   = { AFFINEANIMCMD_FRAME(0x100,0x100,-128,0), AFFINEANIMCMD_FRAME(0x0,0x0,-8,8), AFFINEANIMCMD_END };
static const union AffineAnimCmd sSpriteAffineAnim_RotatingClockwise270to360[]   = { AFFINEANIMCMD_FRAME(0x100,0x100,  64,0), AFFINEANIMCMD_FRAME(0x0,0x0,-8,8), AFFINEANIMCMD_END };
static const union AffineAnimCmd sSpriteAffineAnim_RotatingAnticlockwise360to270[] = { AFFINEANIMCMD_FRAME(0x100,0x100,  0,0), AFFINEANIMCMD_FRAME(0x0,0x0,8,8), AFFINEANIMCMD_END };
static const union AffineAnimCmd sSpriteAffineAnim_RotatingAnticlockwise270to180[] = { AFFINEANIMCMD_FRAME(0x100,0x100, 64,0), AFFINEANIMCMD_FRAME(0x0,0x0,8,8), AFFINEANIMCMD_END };
static const union AffineAnimCmd sSpriteAffineAnim_RotatingAnticlockwise180to90[]  = { AFFINEANIMCMD_FRAME(0x100,0x100,-128,0),AFFINEANIMCMD_FRAME(0x0,0x0,8,8), AFFINEANIMCMD_END };
static const union AffineAnimCmd sSpriteAffineAnim_RotatingAnticlockwise90to0[]    = { AFFINEANIMCMD_FRAME(0x100,0x100, -64,0),AFFINEANIMCMD_FRAME(0x0,0x0,8,8), AFFINEANIMCMD_END };
...
static void Task_SlidingPuzzle_HandleInput(u8 taskId)
{
    ...
    if (JOY_NEW(B_BUTTON))          ExitSlidingPuzzle(taskId);
    else if (JOY_NEW(DPAD_LEFT))    MoveCursor(-1,  0);
    else if (JOY_NEW(DPAD_RIGHT))   MoveCursor( 1,  0);
    else if (JOY_NEW(DPAD_UP))      MoveCursor( 0, -1);
    else if (JOY_NEW(DPAD_DOWN))    MoveCursor( 0,  1);
...
static void MoveCursorSprite(s8 deltaX, s8 deltaY, u8 spriteId)
{
    ...
    if (row < FIRST_SLIDING_PUZZLE_ROW)       row = FINAL_SLIDING_PUZZLE_ROW;
    else if (row > FINAL_SLIDING_PUZZLE_ROW)  row = FIRST_SLIDING_PUZZLE_ROW;
    if (col < FIRST_SLIDING_PUZZLE_COL)       col = FINAL_SLIDING_PUZZLE_COL;
    else if (col > FINAL_SLIDING_PUZZLE_COL)  col = FIRST_SLIDING_PUZZLE_COL;
...
static bool32 CursorIsOnTile(void)
{
    ...
    return sSlidingPuzzle->tiles[cursor->sRow][cursor->sCol] != __;
}
...
static void CheckForSolution(void)
{
    ...
    for (row = 0; row < NUM_SLIDING_PUZZLE_ROWS; row++)
    {
        for (col = 0; col < NUM_SLIDING_PUZZLE_COLS; col++)
        {
            ...
            if (tileId == __)
                continue;
            if (sSlidingPuzzle->tiles[row][col] == __)
            {
